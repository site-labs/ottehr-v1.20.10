...
export const PROJECT_NAME = 'SiteLabs Patient Portal';
export const PROJECT_NAME_SHORT = 'SiteLabs';
export const PROJECT_NAME_LOWER = PROJECT_NAME.toLowerCase();
export const PROJECT_DOMAIN = 'sitelabsglobal.com';
export const PROJECT_WEBSITE = `https://${PROJECT_DOMAIN}`;
export const SUPPORT_EMAIL = 'support@sitelabsglobal.com';
